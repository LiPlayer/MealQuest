...
本系统支持的所有策略均基于 **“TCA 规则引擎”** 动态部署，旨在将商业意图无感转化为用户数字资产。

### 1. 拉新获客 (Acquisition)
*   **新人见面礼**：扫码即送“满减券”或“免费小菜入席令”。
*   **面对面邀请**：老客当面邀请朋友扫码，双方获碎银奖励。
*   **LBS 围栏发券**：路过店铺范围内，弹出“进店关怀券”。
*   **异业联盟**：通过特定合作终端扫码，激活交叉营销资产。

### 2. 促活提频 (Activation)
*   **周期会员日**：每周固定日全场资产（碎银/碎片）双倍产出。
*   **食谱集卡系统**：集齐特定系列碎片，兑换大额霸王餐入席令。
*   **步数挑战赛**：步数达标后到店，触发“健康奖励”折扣。
*   **环境突变关怀**：降雨、高温等异常天气自动触发针对性资产推送。

### 3. 提客单/去库存 (Revenue)
*   **满额惊喜盲盒**：单笔流水触发碎片盲盒掉落。
*   **闲时特惠核销**：在餐厅非高峰段，入席令核销成本降低或返现提升。
*   **AI 暴击掉落**：针对积压 SKU，实时调高对应食材碎片的掉落权重。
*   **阶梯激励模型**：实付金额越高，返还的碎银比例按阶梯指数增长。

### 4. 召回留存 (Retention)
*   **沉默唤醒令牌**：长期未活跃用户定向获赠“老友想念令”。
*   **资产过期预警**：利用“厌恶损失”心理，在碎银过期前触发回店通知。
*   **周年/生日贺礼**：用户注册周年或生日当天，自动生成全特效入席令。

### 5. 社交裂变 (Referral)
*   **入席令转赠**：支持未核销资产在微信/支付宝好友间自由转赠（社交货币）。
*   **支付手气红包**：买单后分享碎片红包至群聊，实现品牌低成本扩散。
*   **团队请客计划**：支持购买“合家欢”大额入席令并实现多人核销。
