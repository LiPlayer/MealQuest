...
3. 审批、回放、风控、自动化、提醒、完整看板等能力统一收纳到“高级工具”二级入口。
...
2. 2026-03-07：补充老板端顶部安全区口径，要求首屏内容不得与系统通知栏重叠。
3. 2026-03-07：明确“无确认不执行”在 AI 提案场景下为 `OWNER` 确认后才进入 Policy OS 执行。
2. 2026-03-07：老板端改为统一极简信息架构（首页/收款码/高级工具），高级能力收纳到工具页。
