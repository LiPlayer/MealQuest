...
| S060 | 生命周期五阶段策略闭环建立 | S050 done | doing |
...
| PKG-S060-CUS-01 | customer | CUS-C06, CUS-C08 | 建立顾客端五阶段触达与小游戏联动体验 | 顾客触达连续体验 | PKG-S060-SRV-01 | todo |
...
| PackageID | Lane | CapabilityID | Macro Requirement | Deliverable | DependsOn | Status |
| --- | --- | --- | --- | --- | --- | --- |
| PKG-S070-SRV-01 | server | SRV-C05, SRV-C06 | 建立提案可解释与决策支持能力 | 提案解释能力 | none | todo |
| PKG-S070-MER-01 | merchant | MER-C04, MER-C05 | 完成老板端 AI 对话、提案同意/驳回闭环 | AI 提案决策流程 | PKG-S070-SRV-01 | todo |
...
18. 2026-03-05：完成 PKG-S050-MER-02，老板端新增“提醒”Tab，接入收件箱/未读汇总/已读回执并支持过滤与分页。
19. 2026-03-05：完成 PKG-S050-CUS-01，顾客端账户页新增消息区，支持执行反馈可见、自动已读与消息失败降级；S050 关闭并切换 S060 doing。
20. 2026-03-06：完成 PKG-S060-SRV-01，服务端新增五阶段策略库查询与启用接口，补齐活跃阶段模板并在老板端看板新增活跃阶段汇总能力。
21. 2026-03-06：完成 PKG-S060-MER-01，老板端回放页新增生命周期策略运营区，支持五阶段状态可见、OWNER 逐阶段启用与看板入口联动。
