const STRATEGY_TEMPLATES = [
  ...
  {
    templateId: "social_asset_transfer",
    category: "SOCIAL_VIRAL",
    phase: "P3",
    name: "入席令转赠",
    description: "资产在用户间守恒流转",
    triggerEvent: "ASSET_TRANSFER",
    defaultBranchId: "DIRECT_TRANSFER",
    branches: [
      {
        branchId: "DIRECT_TRANSFER",
        name: "直接转赠",
        description: "点对点转移，不增发",
        campaign: {
          priority: 40,
          conditions: [{ field: "transferAmount", op: "gte", value: 1 }],
          budget: { cap: 30, used: 0, costPerHit: 0 },
          action: {
            type: "STORY_CARD",
            story: {
              templateId: "tpl_transfer_direct",
              narrative: "你的心意已送达，资产总量守恒。",
              assets: [],
              triggers: ["tap_view"]
            }
          }
      ...
      {
        branchId: "RED_PACKET_SPLIT",
        name: "拼手气红包",
        description: "群内随机瓜分，总量守恒",
        campaign: {
          priority: 45,
          conditions: [{ field: "transferAmount", op: "gte", value: 100 }],
          budget: { cap: 30, used: 0, costPerHit: 0 },
          action: {
            type: "STORY_CARD",
            story: {
              templateId: "tpl_transfer_group",
              narrative: "拼手气红包已发出，大家来抢福气。",
              assets: [],
              triggers: ["tap_view"]
            }
          }
  ...
  {
    templateId: "social_treat_paying",
    category: "SOCIAL_VIRAL",
    phase: "P3",
    name: "请客买单",
    description: "群体支付与老板请客补贴",
    triggerEvent: "GROUP_PAY",
    defaultBranchId: "GROUP_PAY",
    branches: [
      {
        branchId: "GROUP_PAY",
        name: "群买单",
        ...
        campaign: {
          priority: 42,
          conditions: [{ field: "groupPayParticipants", op: "gte", value: 2 }],
          budget: { cap: 80, used: 0, costPerHit: 2 },
          action: {
            type: "GRANT_SILVER",
            amount: 20
          }
      ...
      {
        branchId: "MERCHANT_SUBSIDY",
        name: "老板请客",
        description: "商户补贴群友抢单",
        campaign: {
          priority: 72,
          conditions: [{ field: "groupPayParticipants", op: "gte", value: 2 }],
          budget: { cap: 180, used: 0, costPerHit: 12 },
